...
func configConfigToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/config.toml", size: 1503, mode: os.FileMode(420), modTime: time.Unix(1492356558, 0)}
