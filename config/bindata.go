...
func configConfigToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/config.toml", size: 1501, mode: os.FileMode(420), modTime: time.Unix(1492304746, 0)}
