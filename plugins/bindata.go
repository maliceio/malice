...
func pluginsPluginsToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/plugins.toml", size: 7562, mode: os.FileMode(420), modTime: time.Unix(1532307379, 0)}
