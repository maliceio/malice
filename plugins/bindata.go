...
func pluginsPluginsToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/plugins.toml", size: 6365, mode: os.FileMode(420), modTime: time.Unix(1491662730, 0)}
