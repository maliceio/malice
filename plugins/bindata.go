...
func pluginsPluginsToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/plugins.toml", size: 7577, mode: os.FileMode(420), modTime: time.Unix(1532881438, 0)}
